...
public class JGalo extends JFrame implements ActionListener {
	...
	public static void main(String args[]) {
		...
		} else if(args.length == 1 || args[0].toUpperCase().equals("O") || args[0].toUpperCase().equals("X")){
			new JGalo(new JogoGalo(args[0].toUpperCase().charAt(0)));
		} else{
